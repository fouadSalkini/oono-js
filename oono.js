(function (global, factory) {
    ...
    var createMainWidget = (ctx) => {
      ...
      if (!ctx.options.activeStoriesCount) {
          ...
          ctx.widgetDiv.style.maxWidth = "auto";
          ctx.widgetDiv.style.maxHeight = "auto";
      }
    };
    ...
    var createIframeBtnDiv = (ctx) => {
      ...
      ctx.iframeBtnDiv.style.cssText = "box-sizing:border-box;width:100%;height:100%;box-sizing:border-box";
      if (ctx.options.activeStoriesCount) {
